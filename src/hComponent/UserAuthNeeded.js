//this file contains code for authentication. Some webpages on this website can only be viewed by logged in user. when we wrap WithAuth around the page on app.js. it means this page needs authentication to be viewed.
